...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"color" : [ 0.839216, 0.0, 0.766641, 1.0 ],
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-36",
									"maxclass" : "newobj",
...
,
									"patching_rect" : [ 262.5, 420.0, 111.0, 20.0 ],
...
, 							{
								"box" : 								{
									"color" : [ 0.839216, 0.0, 0.151623, 1.0 ],
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-11",
									"maxclass" : "newobj",
...
,
									"patching_rect" : [ 268.0, 260.0, 97.0, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
,
					"patching_rect" : [ 50.0, 160.0, 335.0, 80.0 ],
					"varname" : "patcher"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.0, 85.0, 37.0, 18.0 ],
					"text" : "led 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 85.0, 37.0, 18.0 ],
					"text" : "led 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 35.0, 32.5, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 35.0, 32.5, 18.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 85.0, 43.0, 18.0 ],
					"text" : "led $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 50.0, 295.0, 55.0, 20.0 ],
					"text" : "route A0"
				}
